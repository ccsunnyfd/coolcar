...
export const rental = $root.rental = (() => {
    ...
    rental.v1 = (function() {
        ...
        v1.CreateTripResponse = (function() {
            ...
            /**
             * Gets the default type url for CreateTripResponse
             * @function getTypeUrl
             * @memberof rental.v1.CreateTripResponse
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            CreateTripResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/rental.v1.CreateTripResponse";
            };
