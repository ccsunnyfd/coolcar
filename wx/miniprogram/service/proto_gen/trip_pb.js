...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.Location = (function() {
        ...
        Location.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/coolcar.Location";
        };
    ...
    coolcar.Trip = (function() {
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (message.status != null && message.hasOwnProperty("status"))
                object.status = options.enums === String ? $root.coolcar.TripStatus[message.status] === undefined ? message.status : $root.coolcar.TripStatus[message.status] : message.status;
            return object;
        };
        ...
        Trip.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/coolcar.Trip";
        };
    ...
    coolcar.GetTripRequest = (function() {
        ...
        GetTripRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/coolcar.GetTripRequest";
        };
    ...
    coolcar.GetTripResponse = (function() {
        ...
        GetTripResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/coolcar.GetTripResponse";
        };
